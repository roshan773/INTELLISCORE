...
export const metadata = {
  title: "Technology Stack — INTELLISCORE | Modern Frameworks & Infrastructure",
  description:
    "Explore INTELLISCORE's production technology stack across Next.js, AI LLM agents, Zero-Trust cryptography, and distributed cloud computing.",
};
